...
// ⚡ Bolt: Extracted clip button to prevent unnecessary re-renders when parent updates
...
// ⚡ Bolt: Extracted scene column to prevent unnecessary re-renders when parent updates
    ...
    <div style={{ display: 'flex', flexDirection: 'column', gap: '8px', padding: '16px' }}>
      ...
      <div style={{ display: 'flex', gap: '16px' }}>
        {matrix.scenes.map(scene => {
          // ⚡ Bolt: Use a stable EMPTY_CLIPS reference to avoid invalidating React.memo
