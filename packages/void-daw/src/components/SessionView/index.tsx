...
// ⚡ Bolt: Stable reference for empty arrays to prevent React.memo invalidation
const EMPTY_ARRAY: SessionClip[] = [];

// ⚡ Bolt: Extracted mapped elements into React.memo wrapped components to prevent O(N) re-renders
...
const SceneColumn = React.memo(({ scene, clips, onSceneTrigger, onClipTrigger }: { scene: Scene, clips: SessionClip[], onSceneTrigger?: (sceneId: string) => void, onClipTrigger?: (clipId: string) => void }) => (
